...
int
CauseCode_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_oer_constraints_t asn_OER_type_CauseCode_constr_1 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_CauseCode = {
	...
	sizeof(asn_DEF_CauseCode_tags_1)
		/sizeof(asn_DEF_CauseCode_tags_1[0]), /* 1 */
	{ &asn_OER_type_CauseCode_constr_1, &asn_PER_type_CauseCode_constr_1, CauseCode_constraint },
