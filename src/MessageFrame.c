...
static const long asn_VAL_16_roadsideSafetyMessage = 33;
static const long asn_VAL_17_testMessage00 = 240;
static const long asn_VAL_18_testMessage01 = 241;
static const long asn_VAL_19_testMessage02 = 242;
static const long asn_VAL_20_testMessage03 = 243;
static const long asn_VAL_21_testMessage04 = 244;
static const long asn_VAL_22_testMessage05 = 245;
static const long asn_VAL_23_testMessage06 = 246;
static const long asn_VAL_24_testMessage07 = 247;
static const long asn_VAL_25_testMessage08 = 248;
static const long asn_VAL_26_testMessage09 = 249;
static const long asn_VAL_27_testMessage10 = 250;
static const long asn_VAL_28_testMessage11 = 251;
static const long asn_VAL_29_testMessage12 = 252;
static const long asn_VAL_30_testMessage13 = 253;
static const long asn_VAL_31_testMessage14 = 254;
static const long asn_VAL_32_testMessage15 = 255;
static const asn_ioc_cell_t asn_IOS_MessageTypes_1_rows[] = {
	...
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_16_roadsideSafetyMessage },
	{ "&Type", aioc__type, &asn_DEF_RoadsideSafetyMessage },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_17_testMessage00 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage00 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_18_testMessage01 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage01 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_19_testMessage02 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage02 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_20_testMessage03 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage03 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_21_testMessage04 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage04 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_22_testMessage05 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage05 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_23_testMessage06 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage06 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_24_testMessage07 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage07 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_25_testMessage08 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage08 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_26_testMessage09 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage09 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_27_testMessage10 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage10 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_28_testMessage11 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage11 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_29_testMessage12 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage12 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_30_testMessage13 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage13 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_31_testMessage14 },
	{ "&Type", aioc__type, &asn_DEF_TestMessage14 },
	{ "&id", aioc__value, &asn_DEF_DSRCmsgID, &asn_VAL_32_testMessage15 },
...
static asn_TYPE_member_t asn_MBR_value_3[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MessageFrame__value, choice.RoadsideSafetyMessage),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_value_tag2el_3[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 0, 0, 31 }, /* BasicSafetyMessageat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 1, -1, 30 }, /* MapDataat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 2, -2, 29 }, /* SPATat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 3, -3, 28 }, /* CommonSafetyRequestat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 4, -4, 27 }, /* EmergencyVehicleAlertat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 5, -5, 26 }, /* IntersectionCollisionat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 6, -6, 25 }, /* NMEAcorrectionsat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 7, -7, 24 }, /* ProbeDataManagementat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 8, -8, 23 }, /* ProbeVehicleDataat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 9, -9, 22 }, /* RoadSideAlertat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 10, -10, 21 }, /* RTCMcorrectionsat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 11, -11, 20 }, /* SignalRequestMessageat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 12, -12, 19 }, /* SignalStatusMessageat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 13, -13, 18 }, /* TravelerInformationat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 14, -14, 17 }, /* PersonalSafetyMessageat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 15, -15, 16 }, /* RoadsideSafetyMessageat 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 16, -16, 15 }, /* TestMessage00at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 17, -17, 14 }, /* TestMessage01at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 18, -18, 13 }, /* TestMessage02at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 19, -19, 12 }, /* TestMessage03at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 20, -20, 11 }, /* TestMessage04at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 21, -21, 10 }, /* TestMessage05at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 22, -22, 9 }, /* TestMessage06at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 23, -23, 8 }, /* TestMessage07at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 24, -24, 7 }, /* TestMessage08at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 25, -25, 6 }, /* TestMessage09at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 26, -26, 5 }, /* TestMessage10at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 27, -27, 4 }, /* TestMessage11at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 28, -28, 3 }, /* TestMessage12at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 29, -29, 2 }, /* TestMessage13at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 30, -30, 1 }, /* TestMessage14at 81 */
    { (ASN_TAG_CLASS_UNIVERSAL | (16 << 2)), 31, -31, 0 } /* TestMessage15at 81 */
};
...
static const asn_TYPE_tag2member_t asn_MAP_MessageFrame_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* messageIdat 71 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* valueat 72 */
};
